...
$(function(){
	...
	var url = "index.php?g=admin&m=keyword&a=showyyst";
...
//							$('#content1').val(v.content1);
//							$('#content2').val(v.content2);
//							$('#content3').val(v.content3);
//							$('#content4').val(v.content4);
//							$('#content5').val(v.content5);
//							$('#content6').val(v.content6);
//							}
//					});
				}
			});
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		var url = "index.php?g=admin&m=keyword&a=yyst&op=add";
		
		$('#ketype').val(ktype);
		$('#kecontent').val(kecontent);
...
//		});
		...
		$('#ketype').val(ktype);
		$('#titles').val(arrTitles);
		$('#imageinfo').val(arrImgurls);
		$('#linkinfo').val(arrCurl);
		//editor.sync();
		//document.getElementById("content1").value=KE.util.getData('content1');
		var form = document.getElementById("form1");
		form.action="index.php?g=admin&m=keyword&a=yyst&op=add";
		form.submit();
		
//		$.post(url,{ketype:ktype,titles:arrTitles,imageinfo:arrImgurls,linkinfo:arrCurl,
//			content1:$('#content1').val(),content2:$('#content2').val(),content3:$('#content3').val(),
//			content4:$('#content4').val(),content5:$('#content5').val(),content6:$('#content6').val()},function(data){
//			alert('保存成功！');
//			window.location.reload();
//		});
