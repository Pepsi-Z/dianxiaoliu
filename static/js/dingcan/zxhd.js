...
$(function(){
	...
	var url = "index.php?g=admin&m=keyword&a=showzxhd";
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		var url = "index.php?g=admin&m=keyword&a=zxhd&op=add";
...
//		});
		...
		var form = document.getElementById("form1");
		form.action="index.php?g=admin&m=keyword&a=zxhd&op=add";
		form.submit();
