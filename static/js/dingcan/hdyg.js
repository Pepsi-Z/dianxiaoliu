...
$(function(){
	...
	var url = "index.php?g=admin&m=keyword&a=showhdyg";
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		var url = "index.php?g=admin&m=keyword&a=hdyg&op=add";
...
//		});
		...
		var form = document.getElementById("form1");
		form.action="index.php?g=admin&m=keyword&a=hdyg&op=add";
		form.submit();
