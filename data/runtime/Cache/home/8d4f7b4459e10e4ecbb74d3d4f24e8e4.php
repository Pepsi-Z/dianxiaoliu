...
<script src="static/js/jquery.raty-0.5/js/jquery.raty.js"></script>
    ...
    <style>
        ...
        .zxy-Logon form .input-group span{background:url("__STATIC__/css/img/zxy-name.png") no-repeat scroll center center / 18px 22px}
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 zxy-Logon">
                <form id="form2" action="<?php echo U('Member/activation_member');?>" method="post">
                    <div class="form-group">
                        <label for="code">激活码：</label>
                        <input id="code" type="text" minlength="6" maxlength="6" class="form-control"  placeholder="请输入6位激活码"/>
                    </div>
                    <div class="form-group">
                        <label for="cardtype">卡号：</label>
                        <input id="cardtype" name="card_number" type="text"  class="form-control" readonly="readonly"  />
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group col-xs-12">
                            <span class="input-group-addon yam"></span>
                            <span></span>
                ...
                <div class="col-xs-12 zxy-payment margin-z"><a id="submit1" href="javascript:;"  class="btn btn-default">我要激活</a></div>
...
<script>
    $(function(){
        ...
        $('#code').blur(function(){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo U('Member/activation_info');?>",
                data: {cards: cards},
                dataType: "json",
                success: function (data) {
                    if(data.status == 1){
                        ...
                        layer.msg('激活码不正确,请重新核实');
                        return false;
                    }else{
                        $('#cardtype').val(data.data);
                    }
