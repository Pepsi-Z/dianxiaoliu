...
<div class="dingwei_w">
    <div>
        ...
        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><span><?php echo ($val["sou"]); ?></span>
            <ul>
                <?php if(is_array($val["na"])): $i = 0; $__LIST__ = $val["na"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Index/city',array('pid'=>$v['id'],'name'=>$v['name']));?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
