...
<script src="static/js/jquery.raty-0.5/js/jquery.raty.js"></script>
    ...
    <style>
        .zxy-standard img{max-width:100%;}
    </style>
</head>
<body>

<section class="margin-z wxh_disbottom">
    <div class="container zxy-introduces">
        <div class="row">
            <div class="col-xs-12 zxy-standard">
                <P><?php echo C('pin_city_money');?></P>
            </div>
            <div class="col-xs-12 zxy-standard">
                <P><?php echo C('pin_city_service');?></P>
            </div>
        </div>
    </div>
</section>
<div style="height:100px;"></div>
<footer class="footer-z c_bottom">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 margin-z zxy-Call">
                <a href="tel:<?php echo C('pin_site_tel');?>" class="btn btn-default"><span>我要寄件 <?php echo C('pin_site_tel');?></span></a>
            </div>
        </div>
    </div>
</footer>
