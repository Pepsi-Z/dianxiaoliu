...
<section>
  <div class="container">
    <div class="row lxt-card">
    	<div class="col-xs-12">
        	<div class="pull-left">
        	<div class="lxt-logo"><img src="__STATIC__/css/img/lxt-logo.png"></div>
                <span>余额：<?php echo ($user["money"]); ?></span>
            <!--<span>有效期：<br />
                <?php if($user["begin_time"] != '' ): ?><i class=""><?php echo ($user["begin_time"]); ?> - <?php echo ($user["end_time"]); ?></i>
                    <?php else: ?>
                   <i class="">无限制</i><?php endif; ?>
            </span>-->
            </div>
            <p class="pull-right text-right"><em>VIP</br></em><?php echo ($user["card_number"]); ?></p>
        </div>
        <div class="col-xs-12">
        	<div class="lxt-rwm text-center"><img src="<?php echo ($user["qr_code"]); ?>"></div>
        </div>
        <div class="form-group lxt_btn_release">
                  <a href="<?php echo U('User/xu_price');?>">
