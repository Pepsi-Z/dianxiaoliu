    ...
    <div class="container yy_index">
        <div class="row">
            <div class="yy_like wxh_like">
             <?php if(is_array($tuijian)): $i = 0; $__LIST__ = $tuijian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="col-xs-12">
                ...
                <?php if(empty($tuijian)): ?><div class="tab-pane" style="margin-top: 15px;">
