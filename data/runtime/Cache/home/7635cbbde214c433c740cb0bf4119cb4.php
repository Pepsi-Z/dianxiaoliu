...
<div class="container">
    <div class="row">
        <div class="col-xs-12 zxy-Logon">
            <form id="form2" action="<?php echo U('Shop/edit_password');?>" method="post">
    ...
    $(function(){
        ...
        $("#submit1").click(function(e){
            ...
            if(t_tel){
                $.ajax({
                    type: "post",
                    url: "<?php echo U('Shop/pass_check_tel');?>",
                    data: {tel: t_tel},
                    dataType: "html",
...
<script>
    function getRegCode(){
        ...
        if(phonenum == null || phonenum == ""){
            ...
            $.ajax({
                type: "post",
                url:"<?php echo U('Shop/getRegCodes');?>",
    ...
    function next(){
        ...
        if(phone == null || phone == ""){
            ...
            $.ajax({
                type: "post",
                url:"<?php echo U('Shop/checkRegCode');?>",
    ...
    function checkuid(){
        ...
        if(strtel.length == 11){
            $.post("<?php echo U('Shop/ajax_hquid');?>",{name:struname,tel:strtel},function(data){
                $('#memid').val(data);
            })
        }
    }
