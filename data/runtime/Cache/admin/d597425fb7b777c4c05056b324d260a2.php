...
<div class="pad_lr_10">
    ...
    <table width="100%" cellspacing="0" id="J_cate_tree">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                    <?php if(!empty($val["img"])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo attach(get_thumb($val['img'], '_m'),'item_cate');?>">
				<img src="<?php echo attach(get_thumb($val['img'], '_m'),'item_cate');?>" style="width:26px; height:26px;" /></span><?php endif; ?>
                </td>
                <td align="center"><span data-tdtype="edit" data-field="name" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["name"]); ?></span></td>
                <td align="center"><b><?php echo ($lable[$val['type']]); ?></b></td>
                ...
                <td align="center">
                    <a href="<?php echo u('item_cate/brand', array('pid'=>$val['id'],'type'=>$val['type'], 'menuid'=>$menuid));?>">商家类型</a> |
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo u('item_cate/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>" data-title="<?php echo L('edit');?> - <?php echo ($val["name"]); ?>"  data-id="edit" data-acttype="ajax" data-width="520" data-height="100"><?php echo L('edit');?></a> |
                    <a href="javascript:void(0);" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo u('item_cate/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['name']);?>"><?php echo L('delete');?></a>
                </td>
