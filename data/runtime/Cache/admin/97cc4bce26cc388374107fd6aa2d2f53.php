...
<div class="dialog_content">
	<form id="info_form" action="<?php echo u('user_merchant/edit');?>" method="post">
        ...
        <tr>
            ...
            <td>
                <select name='mid' id="mid">
                    ...
                    <?php if(is_array($merchant)): $i = 0; $__LIST__ = $merchant;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>' <?php if($vo['id'] == $info['mid']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </td>
        </tr>
        <tr>
...
var check_email_url = "<?php echo U('user_merchant/ajax_check_email', array('id'=>$info['id']));?>";
$(function(){
    ...
    var uploader = new qq.FileUploaderBasic({
        ...
        multiple: false,
        action: "<?php echo U('user_merchant/ajax_upload_imgs');?>",
        inputName: 'img',
