<?php if (!defined('THINK_PATH')) exit();?><body>
	    ...
	    <tr>
			...
			<td>	
                 <input type="hidden" name="store_jd" id="store_jd" value="<?php echo ($jing); ?>" />
                 <input type="hidden" name="store_wd" id="store_wd" value="<?php echo ($wei); ?>" />
				<?php if($jing != null): ?><span id="jingdu">已经选取[<?php echo ($jing); ?>,<?php echo ($wei); ?>]</span>
				<?php else: ?>
				<span id="jingdu">未选取位置，拖动地球标注，以标记具体位置</span><?php endif; ?>
