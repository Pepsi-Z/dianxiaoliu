...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0" class="search_form">
        <tbody>
            ...
            <div class="explain_col">
                ...
                <input type="hidden" name="m" value="score_item_cate" />
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('score_item_cate/ajax_edit');?>">
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                	<a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('score_item_cate/edit', array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($val["name"]); ?>"  data-id="edit" data-acttype="ajax" data-width="400" data-height="130"><?php echo L('edit');?></a> | 
                    <a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('score_item_cate/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['name']);?>"><?php echo L('delete');?></a>
                </td>
    ...
    <div class="btn_wrap_fixed">
    	...
    	<input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('score_item_cate/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
