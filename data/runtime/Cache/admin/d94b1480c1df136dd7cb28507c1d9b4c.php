...
<div class="dialog_content">
	<form id="info_form" name="info_form" action="<?php echo u('score_item_cate/edit');?>" method="post">
...
<script>
var check_name_url = "<?php echo U('score_item_cate/ajax_check_name', array('id'=>$info['id']));?>";
$(function(){
