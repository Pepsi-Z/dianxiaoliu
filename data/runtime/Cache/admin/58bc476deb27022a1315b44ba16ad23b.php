        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
                    ...
                    &nbsp;商品名称 :
                    <input name="goods" type="text" class="input-text" size="25" value="<?php echo ($goods); ?>" /> &nbsp;
    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                    <?php if($val['userName'] != '' ): echo ($val["userName"]); ?>
                        <?php else: ?>
                        <?php echo ($val["name"]); endif; ?>
                ...
                <td align="center">
                    <?php if($val['quantity'] != 0 ): echo ($val["quantity"]); ?>
                        <?php else: ?>
                        1<?php endif; ?>
                </td>
                <td align="center">
                    <?php if($val['goods_sumPrice'] != '' ): echo ($val["goods_sumPrice"]); ?>
                        <?php else: ?>
                        <?php echo ($val["price"]); endif; ?>
...
-->
                ...
                <td align="center">
                    <?php if($val['add_time'] != '' ): echo (date("Y-m-d H:i:s",$val["add_time"])); ?>
                        <?php else: ?>
                        <?php echo (date("Y-m-d H:i:s",$val["time"])); endif; ?>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('member_consume/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
