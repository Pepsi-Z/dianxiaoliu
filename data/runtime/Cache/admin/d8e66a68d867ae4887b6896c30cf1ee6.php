...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr >
                ...
                <td align="center"><a href="<?php echo u('tuan_order/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>"><?php echo ($val["orderId"]); ?></a><br> 
               <?php if($val["sellerRemark"] != ''): ?><a title="【客服备注】<?php echo ($val["sellerRemark"]); ?>">
                <img src="__STATIC__/images/remark.gif" >
                     ...
                     <?php switch($val["status"]): case "1": ?>待付款<?php break;?>
                         ...
                         <?php case "4": ?>已消费<?php break; endswitch;?>
                 </td>
               ...
               <!-- <td align="center" >
                ...
                <td align="center"><a href="<?php echo u('tuan_order/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>">查看</a>
                <?php if($val["status"] == 1): ?>| 
                <a href="javascript:void(0);" class="J_confirmurl" data-uri="<?php echo u('tuan_order/wuxiao', array('id'=>$val['id']));?>" data-acttype="ajax" data-msg="您确定置为无效吗？">置为无效</a><?php endif; ?>
                </td>
    ...
    <div class="btn_wrap_fixed">
      <label class="select_all mr10"><input type="checkbox" name="checkall" class="J_checkall"><?php echo L('select_all');?>/<?php echo L('cancel');?></label>
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('tuan_order/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
