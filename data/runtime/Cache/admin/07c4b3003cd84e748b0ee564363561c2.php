...
<!--添加文章-->
<form id="info_form" action="<?php echo U('score_item/add');?>" method="post" enctype="multipart/form-data">
<div class="pad_lr_10">
	<div class="col_tab">
		...
		<div class="J_panes">
			<div class="content_list pad_10">
				<table width="100%" cellspacing="0" class="table_form">
					...
					<tr>
						<th>商品图片 :</th>
						<td><input type="file" name="img" id="img" class="input-text"  style="width:200px;height:20px;" /></td>
		 			</tr>
		            <tr>
						<th>所需积分 :</th>
