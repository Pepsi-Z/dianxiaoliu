    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th align="center" width="300">商家名称</th>
                <th align="center" width="100">评论星级</th>
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><p style="width:280px;height:18px;line-height:18px;overflow:hidden;"><?php echo ($val["merchant_title"]); ?></p></td>
                <td align="center"><?php echo ($val["startcomment"]); ?>（星级）</td>
