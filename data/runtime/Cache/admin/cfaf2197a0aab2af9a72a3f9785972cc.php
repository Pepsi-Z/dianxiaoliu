...
<div class="pad_lr_10">
    ...
    <table width="100%" cellspacing="0" id="J_cate_tree">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                    <!--<a href="<?php echo u('item_cate/brand_cate', array('id'=>$val['id'],'type'=>$val['type'], 'menuid'=>$menuid));?>">特色商品分类</a> |-->
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo u('item_cate/brand_edit', array('id'=>$val['id'],'type'=>$val['type'], 'menuid'=>$menuid));?>" data-title="<?php echo L('edit');?> - <?php echo ($val["name"]); ?>"  data-id="edit" data-acttype="ajax" data-width="520" data-height="100"><?php echo L('edit');?></a> |
                    <a href="javascript:void(0);" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo u('item_cate/brand_delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['name']);?>"><?php echo L('delete');?></a></td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('item_cate/brand_delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
